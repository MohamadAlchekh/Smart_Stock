...
class _LoginScreenState extends State<LoginScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('Tamam', style: TextStyle(color: Color(0xFF1A237E))),
          ),
        ],
      ),
    );
  ...
  void _handleLogin() {
    ...
    if (_isAdmin) {
      if (username == 'admin' && password == 'admin') {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => const HomeScreen(isAdmin: true, userName: 'Yönetici'),
          ),
        );
      } else {
        _showErrorDialog('Yönetici bilgileri hatalı!');
      }
    } 
    // Normal kullanıcı girişi kontrolü
      ...
      if (personnelProvider.checkCredentials(username, password)) {
        final role = personnelProvider.getRole(username);
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: TextButton(
                            ...
                            style: TextButton.styleFrom(
                              backgroundColor: !_isAdmin ? const Color(0xFF1A237E) : Colors.grey[300],
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        suffixIcon: const Icon(Icons.check, color: Color(0xFF3949AB)),
                        label: Text(
